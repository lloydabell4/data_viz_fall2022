...
![Contextual Help 1](images/studio_contexthelp1.png){.class width="75%" height="75%"}
...
```{r}
#type the code required to call the data function
```

Explore 3 individual datasets by calling them
