...
friends <- read.csv("~data_analysis-visualization_fall2022/2_why-look-at-data/data/friends_info.csv")
```
...
For your next grant, you'd really like to include a figure what has a cow asking (politely) for a strong score. Let's fsigure out how to do that!
